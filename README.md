...
**¿Qué es Salesforce?**  
Es una plataforma que funciona en la nube y sirve para administrar la información de los clientes. Ayuda a las empresas a organizar ventas, servicio y otros procesos en un solo lugar sin necesidad de instalar programas.

**¿Qué es Sales Cloud?**  
Es una solución de Salesforce enfocada en el área de ventas. Permite dar seguimiento a clientes potenciales, oportunidades y cuentas para llevar mejor el proceso de venta.
...
**¿Qué es Health Cloud?**  
Es una solución especializada para el sector salud. Se utiliza para manejar información de pacientes y mejorar la coordinación entre médicos, clínicas y sistemas de atención.

**¿Qué es Marketing Cloud?**  
Permite crear y administrar campañas de marketing digital. Ayuda a enviar correos, mensajes y contenido personalizado según el tipo de cliente.
...
Define qué información se puede usar al crear un reporte. Determina qué objetos y relaciones estarán disponibles para analizar los datos.
...
Muestra los datos más importantes de un registro de forma resumida. Se usa mucho en vistas rápidas y dispositivos móviles.
...
**¿Qué es un Rol?**  
Es la jerarquía de los usuarios dentro de Salesforce. Sirve para controlar qué información puede ver cada persona según su posición.

**¿Qué es una Validation Rule?**  
Se refiere a una regla que valida que los datos ingresados sean correctos. Evita que se guarde un registro si no cumple ciertas condiciones.
...
**¿Qué es un Sandbox?**  
Es un entorno de pruebas de Salesforce. Se usa para hacer cambios y pruebas sin afectar la información real.
...
Se utiliza para importar datos a Salesforce de forma sencilla. Permite cargar información desde archivos como Excel o CSV.
...
Distribuye el trabajo entre los agentes de manera inteligente. Ayuda a equilibrar la carga de trabajo en soporte.

**¿Para qué sirve Chatter?**  
Es una herramienta de comunicación interna. Permite a los usuarios colaborar, comentar registros y compartir información.
...
**¿Qué significa SaaS?**  
Significa Software como Servicio. Es un modelo donde el software se usa a través de internet sin instalarlo localmente.
...
Se refiere a software instalado en servidores propios. La empresa se encarga de su mantenimiento.
...
Es la experiencia total que tiene un cliente con una empresa. Incluye ventas, soporte y comunicación.

**¿Qué significa omnicanalidad?**  
Permite atender al cliente por diferentes canales de forma integrada.
...
**¿Qué es un Proceso Batch?**  
 Ejecuta tareas en segundo plano. Se usa para procesar grandes volúmenes de datos.
